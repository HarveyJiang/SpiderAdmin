<template>
<div>
  <el-form :model="spiderModel" ref="SpiderAdv">
    <el-form-item label="登录?" :label-width="formLabelWidth">
      <el-switch v-model="spiderModel.isLogin"></el-switch>
    </el-form-item>
    <el-form-item v-if="spiderModel.isLogin" label="登录地址" :label-width="formLabelWidth">
      <el-input v-model.trim="spiderModel.loginUrl" auto-complete="off"></el-input>
    </el-form-item>
    <el-form-item v-if="spiderModel.isLogin" label="登录参数" autosize type="textarea" :label-width="formLabelWidth">
    ...
    <el-form-item v-if="spiderModel.isScheduled" label="Cron表达式" :label-width="formLabelWidth">
